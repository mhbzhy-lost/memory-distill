---
id: build-next-invalid-dynamic-suspense
kind: build-recipe
status: proposed
stack:
- react
...
trigger:
  file_pattern: ''
  code_signals: []
  description: 代码可能触发 nextjs/dynamic-import 类故障（Invalid usage of suspense option of
    next/dynamic）
correct_pattern: []
decision_context: []
constraints:
...
# build-next-invalid-dynamic-suspense

## Trigger
**代码可能触发 nextjs/dynamic-import 类故障（Invalid usage of suspense option of next/dynamic）**
