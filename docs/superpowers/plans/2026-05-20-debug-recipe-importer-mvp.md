...
- [x] **Step 2: Add project metadata and dependencies**
...
- [x] **Step 4: Run the CLI smoke test**
...
- [x] **Step 4: Implement schema export**
...
- [x] **Step 5: Add schema CLI command**
...
- [x] **Step 6: Run tests and export schemas**
...
- [x] **Step 3: Implement path layout**
...
- [x] **Step 4: Implement storage helpers**
...
- [x] **Step 1: Write failing source/fetch tests**
...
- [x] **Step 2: Run source/fetch tests to verify they fail**
...
- [x] **Step 3: Implement source list parsing**
...
- [x] **Step 4: Implement explicit fetch**
...
- [x] **Step 5: Add source seed and fetch CLI**
...
- [x] **Step 6: Run source/fetch tests**
...
- [x] **Step 1: Add the React fixture**
...
- [x] **Step 3: Run extraction tests to verify they fail**
...
- [x] **Step 5: Add extract CLI command**
...
- [x] **Step 1: Write failing normalize/render tests**
...
- [x] **Step 2: Run normalize/render tests to verify they fail**
...
- [x] **Step 3: Implement deterministic candidates**
...
- [x] **Step 5: Implement render and equivalence check**
...
- [x] **Step 6: Add extract/import/check commands**
...
- [x] **Step 7: Run normalize/render tests**
...
- [x] **Step 2: Run manifest tests to verify they fail**
...
- [x] **Step 4: Add prompt file and manifest CLI**
...
- [x] **Step 3: Implement review session**
...
- [x] **Step 1: Write failing publish/search tests**
...
- [x] **Step 2: Run publish/search tests to verify they fail**
...
- [x] **Step 4: Implement index and search**
...
- [x] **Step 5: Implement dedupe hints**
...
- [x] **Step 6: Add publish/index/search/get CLI**
...
- [x] **Step 7: Run publish/search tests**
...
- [x] **Step 2: Run refresh test to verify it fails**
...
- [x] **Step 3: Implement refresh stale detection**
...
- [x] **Step 2: Run vertical slice test to verify it fails if any command is incomplete**
...
- [x] **Step 4: Add feedback placeholder and README usage**
...
- [x] **Step 2: Verify design coverage**
...
- [x] **Step 3: Commit plan checkbox updates if implementation updated this plan**
